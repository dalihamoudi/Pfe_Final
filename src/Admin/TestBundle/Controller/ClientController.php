...
use Admin\TestBundle\Form\ClientType;
...
class ClientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdminTestBundle:Client')->findAll();
     ...
     * @Method("POST")
     * @Template("AdminTestBundle:Client:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdminTestBundle:Client')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AdminTestBundle:Client:edit.html.twig")
     */
